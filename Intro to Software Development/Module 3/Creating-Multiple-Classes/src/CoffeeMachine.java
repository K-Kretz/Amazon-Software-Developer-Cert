        ...
        while (true) {
            ...
            switch (choice) {
                case 1:
                    ...
                    Espresso esp = new Espresso(espressoName,espressoRoast,espressoPrice,numberOfShots);
                ...
                case 2:
                    ...
                    Latte lat = new Latte(latteName,latteRoast, lattePrice, milkType, syrupFlavor);
