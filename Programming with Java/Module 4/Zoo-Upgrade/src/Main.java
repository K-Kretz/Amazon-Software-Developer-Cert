...
public class Main {
    public static void writeObjectsToFile(Tiger t, Penguin p, Dolphin d){
        try(FileOutputStream tigerFileOutputStream = new FileOutputStream("tiger.txt");
        ObjectOutputStream tigerObjectOutputStream = new ObjectOutputStream(tigerFileOutputStream);
        FileOutputStream penguinFileOutputStream = new FileOutputStream("penguin.txt");
        ObjectOutputStream penguinObjectOutputStream = new ObjectOutputStream(penguinFileOutputStream);
        FileOutputStream dolphinFileOutputStream = new FileOutputStream("dolphin.txt");
        ObjectOutputStream dolphinObjectOutputStream = new ObjectOutputStream(dolphinFileOutputStream)){
            tigerObjectOutputStream.writeObject(t);
            penguinObjectOutputStream.writeObject(p);
            dolphinObjectOutputStream.writeObject(d);
    ...
    public static void readObjectsFromFile(){
        ...
        try(FileInputStream tigerFileInputStream = new FileInputStream("tiger.txt");
            ObjectInputStream tigerObjectInputStream = new ObjectInputStream(tigerFileInputStream);
            FileInputStream penguinFileInputStream = new FileInputStream("penguin.txt");
            ObjectInputStream penguinObjectInputStream = new ObjectInputStream(penguinFileInputStream);
            FileInputStream dolphinFileInputStream = new FileInputStream("dolphin.txt");
            ObjectInputStream dolphinObjectInputStream = new ObjectInputStream(dolphinFileInputStream)){

            tiger = (Tiger) tigerObjectInputStream.readObject();
            penguin = (Penguin) penguinObjectInputStream.readObject();
            dolphin = (Dolphin) dolphinObjectInputStream.readObject();
